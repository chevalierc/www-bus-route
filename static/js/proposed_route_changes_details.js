angular.module( 'routeDetail', [] );

angular.module( 'routeDetail' ).component( 'routeComments', {
    templateUrl: 'angular_directives/proposed_route_changes_details.html'
} )
